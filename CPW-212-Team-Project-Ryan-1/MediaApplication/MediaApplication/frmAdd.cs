    ...
    public partial class frmAdd : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (chbxMovie.Checked)
            {
                ...
                //This looks kind of funky because the castlist dbentity and the castlist itself autogenerated to the same name.
                movie.CastList.CastList1 = txtCast.Text;
                movie.Awards.AwardsName = txtAward.Text;
                db.Movies.Add(movie);
                db.SaveChanges();             
            }
            else if (chbxTVShow.Checked)
            {
                ...
                show.CastList.CastList1 = txtCast.Text;
                show.Awards.AwardsName = txtAward.Text;
                db.TVShows.Add(show);
                db.SaveChanges();
            }
            this.Close();
